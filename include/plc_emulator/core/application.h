...
namespace plc {
    ...
    private:
        ...
        void OpenRtlComponentEditor(int component_id);
        ...
        enum class RtlToolSetupOperation {
            kNone,
            kInstallAll,
            kRemoveAll,
        };
        bool rtl_tool_setup_running_ = false;
        std::atomic<int> rtl_tool_setup_phase_{0};
        RtlToolSetupOperation rtl_tool_setup_operation_ =
            RtlToolSetupOperation::kNone;
        std::future<AudioRtlProcessResult> rtl_tool_setup_future_;
        bool rtl_async_task_running_;
        std::future<RtlAsyncTaskResult> rtl_async_task_future_;
        std::string rtl_editor_focus_module_id_;
        ...
        bool PromptSaveProjectPackageDialog(
            const std::string& default_file_name = "project.acproj",
            const std::string& project_name = "Audio_Circuit_Project");
        ...
        bool RemoveRtlToolchain();
        void PollRtlToolSetup();
