...
const ComponentDefinition* const kDefinitions[] = {
    ...
    GetAudioResistorDefinition(),
    GetAudioPotentiometerDefinition(),
    GetAudioCapacitorDefinition(),
    GetAudioInductorDefinition(),
    GetAudioDiodeDefinition(),
    GetAudioBjtNpnDefinition(),
    GetAudioBjtPnpDefinition(),
    GetAudioOpAmpDefinition(),
    GetAudioSpeakerDefinition(),
    GetAudioGroundDefinition(),
    GetAudioDcSourceDefinition(),
    GetAudioAcSourceDefinition(),
    GetAudioPulseSourceDefinition(),
